...
public class WeaponHandler : MonoBehaviour
{
    ...
    public void Spawn(GameObject wielderObject)
    {
        ...
        // Eventually, we will want to sort by InputHandler / AIHandler / etc.
        wielder.GetComponent<InputHandler>().SetWeaponHandler(this);
    ...
    /// <summary>
    /// Called by <see cref="InputHandler.OnAttackStarted"/> on <see cref="wielder"/>.
    /// </summary>
